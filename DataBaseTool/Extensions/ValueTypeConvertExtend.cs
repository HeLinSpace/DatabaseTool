...
namespace DataBaseTool.Extension
{
    ...
    public static class ValueTypeConvertExtend
    {
        ...
        {
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(bool), new BooleanChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(int), new IntChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(byte), new ByteChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(DateTime), new DateTimeChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(decimal), new DecimalChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(float), new FloatChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(double), new DoubleChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(long), new LongChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(short), new ShortChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(bool?), new BooleanChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(int?), new IntChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(byte?), new ByteChangeValue());
            Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryAdd(typeof(DateTime?), new DateTimeChangeValue());
        ...
        public static bool IsCheckType<T>(this string value)
        {
            ...
            if (!Singleton<ConcurrentDictionary<Type, IChangeValue>>.Instance.TryGetValue(type, out changeType))
            {
                return false;
            }
